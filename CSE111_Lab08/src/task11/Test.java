...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Account 01: "+"\n"+acc1.getName()+" ID: "+acc1.getAccountID()+" Address: "+acc1.getAddress()+" Balance: "+acc1.getBalance()+" ");
		acc1.addInterest();
		System.out.printf("\n"+"Account 02: "+"\n"+acc2.getName()+" ID: "+acc2.getAccountID()+" Address: "+acc2.getAddress()+" Balance: "+acc2.getBalance()+"\n");
		System.out.printf("\n"+"Account 03: "+"\n"+acc3.getName()+" ID: "+acc3.getAccountID()+" Address: "+acc3.getAddress()+" Balance: "+acc3.getBalance()+" ");
		acc3.addInterest();
	}
